...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="{{ asset('/sbadmin/dist/css/timeline.css')}}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{ asset('/sbadmin/dist/css/sb-admin-2.css')}}" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="{{ asset('/sbadmin/bower_components/morrisjs/morris.css')}}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('/sbadmin/bower_components/raphael/raphael-min.js')}}"></script>
    <script src="{{ asset('/sbadmin/bower_components/morrisjs/morris.min.js')}}"></script>
    <script src="{{ asset('/sbadmin/js/morris-data.js')}}"></script>
